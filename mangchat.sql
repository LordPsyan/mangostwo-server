Index: MangChat.sql
===================================================================
--- MangChat.sql	(revision 0)
+++ MangChat.sql	(working copy)
@@ -0,0 +1,71 @@
+-- --------------------------------
+-- New MangChat.sql File Created by Shinzon:03-19-2012
+-- --------------------------------
+
...
+
+-- ----------------------------
+-- SAMPLE RECORD for AutoAnnouncer
+-- ----------------------------
+INSERT INTO `IRC_AutoAnnounce` (`id`,`message`,`addedby`) VALUES ('1','Welcome to MangChat! Add or change automated messages in this table.','Installer');
+
